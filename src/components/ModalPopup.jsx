...
export default function ModalPopup({ isOpen, onClose, clause }) {
            ...
            <div className="p-6">
              ...
              <div>
                ...
                <p className="text-white/90 leading-relaxed text-base">
                  {clause.explanation || "This means that you are agreeing to the terms outlined in the document, which may have legal or financial implications if broken. Ensure you fully understand the liability involved."}
                </p>
              </div>
            </div>
