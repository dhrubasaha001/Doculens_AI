...
export default function UploadCard({ isAnalyzing, onAnalyze }) {
            ...
            >
                ...
                >
                  ...
                  {hasFile ? (
                    ...
                    >
                      ...
                      <p className="text-sm text-white/40 mb-8 max-w-[250px] mx-auto">Supports PDF, DOCX, and Text files up to 50MB</p>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                ...
                <motion.button 
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={onAnalyze}
                  className="flex-1 bg-surface hover:bg-surfaceHover border border-border text-white font-medium py-3.5 rounded-xl transition-all hover:border-white/20 hover:shadow-lg"
                >
                  Try Sample Document
                </motion.button>
              </div>
